...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      // Apple "Fluid Interfaces" curves, opt-in via `ease-spring`/`ease-spring-bounce` for
      // entrances/exits — Tailwind's DEFAULT stays neutral for plain hover/color transitions.
