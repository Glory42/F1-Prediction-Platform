import {
  predictionResponse, raceDetailResponse, raceControlMessages, raceOvertakes, teamRadioClips, trackLocations, predictionHistory, intelStandings,
...
Bun.serve({
  ...
  fetch(req) {
    ...
    if (url.pathname === '/api/races/1/track-replay') return ok(trackLocations);
